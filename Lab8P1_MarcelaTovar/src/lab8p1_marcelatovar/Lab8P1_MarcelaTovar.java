...
public class Lab8P1_MarcelaTovar {
    ...
    public static void DcVsMarvel(){
        ...
        DC.add(Superman);
        Superheroe MujerMaravilla = new Superheroe("MujerMaravilla","DC","Diana Prince","Temiskira");
        ...
        if (opcion == 1) {
            Superheroe super2 = null;
            Superheroe super1 = null;
            ...
            while(n!=1){
                ...
                if (francicia.equalsIgnoreCase("DC")) {
                    ...
                    System.out.println("Se ha añadido correctamente "+nuevo.getNombre()+" a la lista DC");
                    break;
                    }
                    }
                  break;
                    ...
                    System.out.println("Se ha añadido correctamente "+nuevo.getNombre()+" a la lista Marvel");
                    break;
                    }
                    }
                  break;
